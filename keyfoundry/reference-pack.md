...
| [사진-1.pdf](https://drive.google.com/file/d/1xh76Iq5bd-na8N0lNiRGA8hKnrNarJx0/view) — 이사회 보고 매출/수익성 시나리오 비교 | "4월 이사회 보고(a)" vs "Case 2_102K(b)" FY26~FY30 매출·매출총이익·영업이익·EBITDA·CapEx·Ending Cash·ASP 비교 + BCD Prime/Normal_MPS/Discrete/H·V/M·S/NVM 등 제품별 매출 상세. Sales Planning/Marketing/총괄 1순위 참조 |
| [사진-2.pdf](https://drive.google.com/file/d/1ifLEa_EAtAVrVol2_bJONmyZXFBjg56h/view) · [사진-3.pdf](https://drive.google.com/file/d/1ZUYHbS6G8CeC-SvuNetw_iQeSN8oeXaG/view) — 자사 Application 포트폴리오 현황 (동일 슬라이드 중복 촬영본 2장) | Automotive/AI&Data Center/Industrial/Consumer/Communication별 매출 비중과 Y26~Y28 추이, Application Level 1/2/3별 비중 및 주요 고객(MPS, Vishay, Elmos, LXS, 3PEAK 등) 매핑. Marketing(포트폴리오 전략)/Technical Marketing(고객 tech trend)/Sales Planning(mix) 참조 |

> 두 핵심 파일(Market Diagnosis, 하반기 웍샾 아젠다)은 요청 시점에 다른 파일명으로 이미 폴더에 존재해 검색으로 재확인했다. 파일 ID 기준으로 링크했으므로 향후 파일명이 다시 바뀌어도 링크는 유지된다.
>
> 위 3개 파일은 2026-07-06 사용자가 직접 Drive 키파운드리 폴더에 업로드했다(원본 카메라 파일명 "사진-N.pdf" 그대로, 리네임 도구가 없어 파일명은 유지). 처음 채팅에 첨부됐던 "고객사×지역×Tech.별 sqm 수요전망(2023~2030)" 표 문서는 이번 업로드에 포함되지 않았고, 사용자 확인 결과 추가 업로드하지 않기로 했다. 상세 배경은 Notion [신규 참조자료 안내 — 고객 수요전망 & 이사회 보고 매출시나리오 (2026-07-06)](https://app.notion.com/p/3958899a4794816fa947e583c7bdbe33) 참고.
